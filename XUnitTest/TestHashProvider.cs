    ...
    public class TestHashProvider
    {
        ...
        public void TestSha256Hash()
        {
            ...
            Assert.Equal("af746f4327e27195a1345b89b4c10a6a79072cae1146f5adefc8d72fc25039a5",
                hash.Hash(HashAlgorithms.SHA256, "Write your first tests"));
        }
        [Fact]
        public void TestSha256HashWithSalt()
        {
            var hash = new HashProvider();
        ...
        public void TestSha512Hash()
        {
            ...
            Assert.Equal(
                ...
                hash.Hash(HashAlgorithms.SHA512, "Write your first tests"));
        }
        [Fact]
        public void TestSha512HashWithSalt()
        {
            var hash = new HashProvider();
        ...
        public void TestMd5Hash()
        {
            ...
            Assert.Equal("c65ef3d3fc00bede77458568299680c6",
                hash.Hash(HashAlgorithms.MD5, "Write your first tests"));
        }
